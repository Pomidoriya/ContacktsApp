...
namespace ContactsApp.UnitTests
{
    ...
    class PhoneNumberTest
    {
        ...
        [TestCase("11111111111", "Должно возникать исключение, если номер начинается не с 8",
            TestName = "Присвоение number номера телефона, начинающегося не с 8")]
        ...
        [
            TestCase("87078677680", "Тест пройден, если номер телефона присвоен успешно",
        ...
        [TestCase("87078677680", "Геттер phone, возвращает номер телефона",
